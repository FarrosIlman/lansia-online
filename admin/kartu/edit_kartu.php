	...
	<form action="" method="post" enctype="multipart/form-data">
		<div class="card-body">
			<div class="form-group row">
				...
				<div class="col-sm-2">
					<input type="text" class="form-control" id="id_penanggung" name="id_penanggung" value="<?php echo $data_cek_p['id_penanggung']; ?>" readonly />
				</div>
			</div>
...
if (isset($_POST['Ubah'])) {
	$sql_ubah =
		"UPDATE tb_penanggung,tb_pasien SET 
